...
:: - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - ::
::                                                                                                                                     ::
:: Made by Luca also known as "Namensauswahl"                                                                                         ::
...
echo └─────────────────────────────────────────┘
echo.
echo %color_dark_gray%www.github.com/Namensauswahl%color_reset%
echo.
echo %color_dark_gray%Gem Miner 2 v0.9.7%color_reset%
echo %color_dark_gray%2023 FF Studios%color_reset%
...
echo.
echo Follow me on: www.github.com/Namensauswahl
echo.
echo.
echo -Links-
echo %color_gems%Gem Miner 1:%color_reset% www.github.com/Namensauswahl
echo.
echo.
echo -Credits-
echo %color_red%Game Programmed by:%color_reset% @Namensauswahl
echo %color_green%Colored by:%color_reset% @Namensauswahl
echo %color_aqua%Original Idea by:%color_reset% @Namensauswahl
